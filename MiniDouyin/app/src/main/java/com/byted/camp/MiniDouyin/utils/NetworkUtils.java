...
import com.byted.camp.MiniDouyin.beans.Feed;
import com.byted.camp.MiniDouyin.beans.FeedResponse;
...
public class NetworkUtils {
    ...
    public static FeedResponse getResponseWithRetrofit() {
        ...
        try {
            response = retrofit.create(IMiniDouyinService.class).fetchResource().execute();
